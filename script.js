...
class Calculator {
  ...
  compute() {
    ...
    this.currentOperand = "Hi, miss you, Kumusta ka? Could we talk again and maybe go out soon? I'd love to catch up and spend some time together.Looking forward to it.";
    this.operation = undefined;
    this.previousOperand = '';
    this.updateDisplay();
